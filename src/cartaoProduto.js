...
export function renderizarCatalogo() {
	for (const produtoCatalogo of catalago) {
		const cartaoProduto = `<div class="border-solid rounded-lg shadow-xl shadow-slate-400 w-48 m-2 flex flex-col p-2 justify-between group ${
            ...
            <button id="adicionar-${
				produtoCatalogo.id
			}" class="hover:bg-slate-700 bg-slate-950 text-slate-200">
